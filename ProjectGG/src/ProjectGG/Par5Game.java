...
public class Par5Game extends JPanel implements Runnable {
	int user;
	int angle = 5;
	int angle_vel = 1;
	int power = 0;
	...
	Image icPar5, icFlag, icStart, icEnd, ball1, icCart, icBird, icSun;
	...
	public Par5Game(int user) {
		this.user = user;
		icPar5 = Toolkit.getDefaultToolkit().getImage("src/images/Par5Hole.png");
		...
		icCart = Toolkit.getDefaultToolkit().getImage("src/images/Par5CartMove.gif");
		icBird = Toolkit.getDefaultToolkit().getImage("src/images/Par5BirdMove.gif");
		icSun = Toolkit.getDefaultToolkit().getImage("src/images/Par5Sun.gif");
		...
		ball1 = Toolkit.getDefaultToolkit().getImage("src/images/ball1.png");
	...
	public void Score() {
		...
		lb.setBounds(795, 432 - 80, 440, 50);
		lb.setOpaque(false);
		...
		lb1.setBounds(795, 432 - 80 + 30, 440, 50);
		lb1.setOpaque(false);
		...
		if (user == 2) {
			...
			lb2.setBounds(795, 432 - 80 + 60, 440, 50);
			lb2.setOpaque(false);
			...
			lb3.setBounds(795, 432 - 80 + 90, 440, 50);
			lb3.setOpaque(false);
			...
			lb4.setBounds(795, 432 - 80 + 120, 440, 50);
			lb4.setOpaque(false);
		...
		case 5:
			...
			if (hollx - 20 < ballx[user_i] && ballx[user_i] < hollx + 20) {
				...
				if (cnt == 2) {
					...
					score_list[play_j][user_i] = 3;
					System.out.println("player" + user_i + " is " + "TripleBogey!!");
				}else if (cnt == 9) {
					g.drawImage(igmQaudrupleBogey, getWidth()/2-320, getHeight()/2-110, 640, 220, this);
					score_list[play_j][user_i] = 4;
					System.out.println("player" + user_i + " is " + "QaudrupleBogey!!");
				} else if (cnt >= 10) {
					g.drawImage(igmDoublePar, getWidth() / 2 - 210, getHeight() / 2 - 110, 420, 220, this);
					score_list[play_j][user_i] = 5;
