...
public class Par4Game extends JPanel implements Runnable {
	int user;
	int angle = 5;
	int angle_vel = 1;
	int power = 0;
	...
	Image icPar4, icFlag, icStart, icEnd, ball1, icStar;
	...
	public Par4Game(int user) {
		this.user = user;
		icPar4 = Toolkit.getDefaultToolkit().getImage("src/images/Par4Hole.png");
		...
		icStar = Toolkit.getDefaultToolkit().getImage("src/images/Par4Star.gif");
	...
	public void Score() {
		...
		lb.setBounds(730, 432 - 20, 440, 50);
		lb.setOpaque(false);
		...
		lb1.setBounds(730, 432 - 20 + 30, 440, 50);
		lb1.setOpaque(false);
		...
		if (user == 2) {
			...
			lb2.setBounds(730, 432 - 20 + 60, 440, 50);
			lb2.setOpaque(false);
			...
			lb3.setBounds(730, 432 - 20 + 90, 440, 50);
			lb3.setOpaque(false);
			...
			lb4.setBounds(730, 432 - 20 + 120, 440, 50);
			lb4.setOpaque(false);
	...
	protected void paintComponent(Graphics g) {
		g.drawImage(icPar4, 0, 0, getWidth(), getHeight(), null);
		g.drawImage(icFlag, 1000, 660, 70, 95, this);
		g.drawImage(icStar, 1000, 300, 10, 10, this);
		switch (step) {
		case 0:
